...
export async function apiPost<TResponse, TRequest = unknown>(
  ...
  const response = await apiClient.post<ApiResult<TResponse>>(
    url,
    body,
...
export async function apiPut<TResponse, TRequest = unknown>(
  ...
  const response = await apiClient.put<ApiResult<TResponse>>(
    url,
    body,
    createConfig(options),
  );
...
export async function apiPatch<TResponse, TRequest = unknown>(
  ...
  const response = await apiClient.patch<ApiResult<TResponse>>(
    url,
    body,
    createConfig(options),
  );
...
export async function apiDelete<TResponse>(
  ...
  const response = await apiClient.delete<ApiResult<TResponse>>(
    url,
    createConfig(options),
  );
  return unwrapApiResult<TResponse>(response.data);
...
export async function apiPostWithoutData<TRequest = unknown>(
  url: string,
  body?: TRequest,
  options?: RequestOptions,
): Promise<void> {
...
export async function apiDeleteWithoutData(
  url: string,
  options?: RequestOptions,
): Promise<void> {
  const response = await apiClient.delete<ApiResultWithoutData>(
    url,
    createConfig(options),
  );
  unwrapApiResultWithoutData(response.data);
